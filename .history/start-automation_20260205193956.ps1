# Enhanced Docker Automation Startup Script for Windows PowerShell (Headless)
...
Write-Host "═══════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host "🎉 Headless Automation is Running!" -ForegroundColor Green
Write-Host "═══════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "📂 Output files will be saved in: $(Get-Location)" -ForegroundColor Cyan
Write-Host ""
Write-Host "═══════════════════════════════════════════════════════════" -ForegroundColor Cyan
